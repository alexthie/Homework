...
* Task 3.1, incomplete; -8
* Task 3.2, incomplete; -8
    * `quantile` should be run for each row of `league$sims`
* Task 3.3, incomplete; -8
    * output of `quantile(league)` should be formatted and returned
* Task 3.4, incomplete; -4
