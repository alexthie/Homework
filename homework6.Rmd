...
plot(1:10, ap, xlab = 'bootstrap interval', ylab= 'outcome')
lines(out)
...
legend(x = 6, y = 130 , c('treatment group 1', 'treatment group 2'), lty = c(1,1), lwd = c(1,1), col = c('blue', 'red'))
...
mean.medicalRecord <- mean(lapply(medicalRecord, [5,6,7]))
